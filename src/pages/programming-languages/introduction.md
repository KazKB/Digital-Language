...
title: "Programming Languages - Digital Language"
description: "Overview of the different aspects of Programming Languages."
...
- [Levels](#programming-languages "Programming Languages")
- [Types](#types-0f-languages "Types of Languages")
- [Front-End Vs Back-End](#front-end-vs-back-end "Front-End Vs Back-End")
- [Compiler Vs Interpreter](#compiler-vs-interpreter "Compiler Vs Interpreter")
- [Integrated Development Environment](#integrated-development-environment-ide "Integrated Development Environment")

---

### Levels 

Programming Languages are used in the creation of applications, databases, games, programs, operating systems and websites, just to name a few. These languages fall under different levels that can be further broken down into generations (i.e versions). And they can also be distinguished by different categories such as front-end or back-end, interpreted or compiled, and types of language.  
...
- [Procedural](#procedural-programming-languages "Procedural Programming Languages")
- [Functional](#functional-programming-languages "Functional Programming Languages")
- [Object-Oriented Programming (OOP)](#object-oriented-programming-languages "Object Oriented Programming Languages")
- [Scripting](#scripting-programming-languages "Scripting Programming Languages")
- [Logic](#logic-programming-languages "Logic Programming Languages")  
